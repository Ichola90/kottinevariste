...
const ContactSection: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("L'envoi du message a échoué. Merci de réessayer plus tard.");
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Pour toute proposition de collaboration de recherche, co-publication, invitation à un
            colloque ou question sur mes travaux, n'hésitez pas à me contacter.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto items-stretch">
          <div className="h-full">
            <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-800 rounded-xl p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold mb-6 text-gray-900 dark:text-white">Coordonnées</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Institution</h4>
              ...
              <div className="mt-10">
                <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Disponibilité</h4>
                <p className="text-gray-600 dark:text-gray-400">
                  Ouvert aux collaborations de recherche, co-publications, participations à des
                  comités scientifiques et invitations à des colloques ou séminaires.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="h-full">
            <div className="h-full flex flex-col bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-md relative overflow-hidden">
              ...
              <h3 className="text-xl sm:text-2xl font-bold mb-6 text-gray-900 dark:text-white relative z-10">Envoyer un message</h3>
              ...
              {isSubmitted ? (
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-center text-green-800 dark:text-green-400">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Merci pour votre message, une réponse vous sera apportée prochainement.</p>
                  </div>
                </div>
              ) : (
                <form ref={form} onSubmit={handleSubmit} className="relative z-10 flex-1 flex flex-col">
